...
const Step3Report = ({ report }) => {
  ...
  //   doc.text(`Confidence & Clarity: ${confidence}`, margin + 10, currentY + 10)
  //   doc.text(`Communication: ${communication}`, margin + 10, currentY + 18)
  //   doc.text(`Correctness & Completeness: ${correctness}`, margin + 10, currentY + 26)
  ...
  //       q.question,
  //       `${q.score}/10`,
  //       q.feedback || "You did not submit an answer"
  //     ]),
  //     styles: {
  //       fontSize: 9,
  //       cellPadding: 5,
  ...
  const downloadPDF = () => {
    ...
    doc.text(`Confidence & Clarity: ${confidence}`, margin + 10, currentY + 11)
    doc.text(`Communication: ${communication}`, margin + 10, currentY + 20)
    doc.text(`Correctness & Completeness: ${correctness}`, margin + 10, currentY + 29)
    ...
    doc.setFillColor(255, 255, 255)
    doc.setDrawColor(220)
    doc.roundedRect(margin, currentY, contentWidth, 30, 4, 4)
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          initial={{opacity: 0}}
          animate={{opacity: 1}}
            className="bg-white rounded-2xl sm:rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8">
              ...
              {questionWiseScore.map((q, i) => (
                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                  ...
                  <div className="bg-green-50 border border- green-200 p-4 rounded-lg">
                    <p className="text-sm text-green-600 font-bold mb-1">AI Feedback</p>
