...
import { BsRobot, BsBarChart, BsClock, BsFileEarmark, BsFileEarmarkText, BsMic } from 'react-icons/bs'
...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col">
      ...
      <div className="flex-1 px-6 py-18">
                ...
                [
                  {
                    ...
                    desc: "Scores communicatiion, technical accuracy and confidence"
                  },
                  {
                    image: resumeImg,
                  ...
                  },
                  {
                    ...
                    desc: "Detailed strengths, weaknessed and improvement insights"
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
