    ...
    <div className={`
        ...
        `}>
            <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <h2 className="font-semibold text-lg">Naam</h2>
            </div>

            <h1 className="text-2xl md:text-3xl font-semibold text-center leading-normal mb-4">
                Continue with
                <span className="bg-green-100 text-green-600 px-3 py-1 rounded-full inline-flex items-center gap-2">
                    <IoSparklesSharp size={14}/> AI Smart Interview
                </span>
            </h1>
